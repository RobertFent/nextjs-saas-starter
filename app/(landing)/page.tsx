				...
				<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
					<div className='lg:grid lg:grid-cols-3 lg:gap-8'>
						...
						{IngredientElement(
							...
							'Clerk Integration',
							'Secure and streamlined user authentication with Clerk`s modern identity management platform.'
						)}
						{IngredientElement(
							<ChartArea className='h-6 w-6' />,
							'PostHog Integration',
							'Powerful product analytics and event tracking to help you understand user behavior and optimize your application.'
						)}
					</div>
				</div>
			</section>
